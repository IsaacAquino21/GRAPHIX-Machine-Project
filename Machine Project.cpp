...
int main(void)
{
    ...
    /* Enemy Models */
    Model enemyModels[6] = {
        Model("3D/SubmarineV1.obj", glm::vec3(30.5f, -5.0f, 18.5f), 0.01f, glm::vec3(45.0f, 0.0f, 0.0f), modelShaders[3]),
        ...
        Model("3D/Dolphin/Dolphin.obj", glm::vec3(25.0f, 3.0f, -15.0f), 0.025f, glm::vec3(30.0f, 90.0f, 0.0f), 
            modelShaders[2],
            MyTexture("3D/Dolphin/Dolphin.jpg", false)
        ),
        Model("3D/SeaTurtle/SeaTurtle.obj", glm::vec3(15.0f, -4.0f, -9.5f), 0.025f, glm::vec3(45.0f, 45.0f, -120.0f),
            modelShaders[2],
            MyTexture("3D/SeaTurtle/SeaTurtle.jpg", false)),
        Model("3D/SharkV2/SharkV2.obj", glm::vec3(13.0f, -4.0f, 8.5f), 0.025f, glm::vec3(-45.0f, 90.0f, 30.0f), 
            modelShaders[2], 
